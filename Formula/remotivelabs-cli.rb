...
#
#   0.26.0       CLI version, e.g. 0.23.1
#   beamy-public-releases        public GCS bucket name (vars.RELEASE_BUCKET)
#   26ea0550062c38f6afe1825d1767f74651426ef132182f29b7825e66d967e240     sha256 of the arm64-darwin bundle
#
...
class RemotivelabsCli < Formula
  ...
  # version is scanned from the URL (0.26.0) — do not set it explicitly.
  license :cannot_represent # proprietary — see LICENSE

  # Apple Silicon (arm64) only — no Intel/x86_64 macOS build is published.
  on_macos do
    on_arm do
      url "https://storage.googleapis.com/beamy-public-releases/remotivelabs-cli/0.26.0/remotivelabs-cli-0.26.0-arm64-darwin.tar.gz"
      sha256 "26ea0550062c38f6afe1825d1767f74651426ef132182f29b7825e66d967e240"
    end
  end
